...
class AutoCutText {
	...
	function __construct($data, $number){
		...
		$this->_data		=	mostidy_clean($data,false,false);
		...
		$this->_subtext = mostidy_clean($this->_subtext,false,false);	
		$this->_remaintext = mostidy_clean($this->_remaintext,false,false);
	}
